...
public interface AuditLogRepository extends JpaRepository<AuditLog, Long> {
    ...
    List<AuditLog> findByActionTypeAndEntityTypeAndEntityId(String actionType, String entityType, Long entityId);
    ...
    List<AuditLog> findRecentActionsByType(@Param("actionType") String actionType, @Param("since") LocalDateTime since);
}